...
**2.1** `getCandidatesForAdmin` クエリ関数を実装する
...
**2.2** `getCandidateProfileDetail` クエリ関数を実装する
...
**2.3** `packages/db/src/queries/admin/index.ts` に候補者クエリを re-export する
...
### タスク 9: スキルアンケート CMS Server Actions
