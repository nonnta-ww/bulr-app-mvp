...
- [x] 3.1 (P) 再回答クールダウン判定の純関数を実装しテストする
...
- [x] 3.2 (P) 成長推移の時系列整形の純関数を実装しテストする
...
- [x] 5.1 (P) 強み/弱み/成長アクション表示を共有コンポーネントへ抽出する
