...
- [ ] 1. Foundation: seed 雛形・登録
- [ ] 1.1 product-manager seed の型・survey ルートを作成し登録経路へ組み込む
...
- [ ] 2. Core: プロフィールと8コンピテンシーの設問・選択肢を設計どおり作成
- [ ] 2.1 PdM経験プロフィールと前半4コンピテンシーを作成
...
- [ ] 3.2 JOBTYPE_DEFAULT_VOCATION へ策士マッピングを追加
