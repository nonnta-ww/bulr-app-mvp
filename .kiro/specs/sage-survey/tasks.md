...
- [ ] 1. Foundation: seed 雛形・冪等ランナー登録
- [ ] 1.1 ai-ml seed の型・survey ルート・冪等ランナーを作成し登録経路へ組み込む
...
- [ ] 2. Core: 6カテゴリの設問・選択肢を設計どおり作成
- [ ] 2.1 機械学習基礎・モデル開発・評価を作成
...
- [ ] 3. Integration: 全件投入・職掌マッピング追加・一貫性確認
- [ ] 3.1 (P) seed 全件投入・displayOrder・必須・proficiency の通し確認
...
- [ ] 3.2 (P) JOBTYPE_DEFAULT_VOCATION に ai-ml→sage を1行追加
...
- [ ] 4.2 (P) definitions.ts の単体テストを更新
...
- [ ] 4.3 候補者フロー・自己分析・クラス診断での再利用挙動を検証
