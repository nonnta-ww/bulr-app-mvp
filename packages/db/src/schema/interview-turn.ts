...
export const interviewTurn = pgTable(
  'interview_turn',
  {
    ...
    // added by realtime-interview-capture spec, migration 0015 (additive/nullable)
    turn_fingerprint: text('turn_fingerprint'),
  },
  (t) => [
    uniqueIndex('interview_turn_session_fingerprint_unique').on(t.session_id, t.turn_fingerprint),
  ],
);
