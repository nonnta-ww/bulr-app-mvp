/**
 * axis-bars.tsx — 思考スタイル4軸のバイポーラ可視化（task 4.1 / R2.2, R2.3）
 *
...
import { AXES, AXIS_LABELS, type ThinkingStyleAxis } from '../../_lib/thinking-style/axes';
import type { AxisReading } from '../../_lib/thinking-style/score';
