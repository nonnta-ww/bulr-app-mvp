...
>
> **更新 2026-05-23**: 候補者/企業/運営の3アプリ化と候補者プロダクトの再定義（履歴書＋スキルアンケートでのエントリー、自己診断、AI 模擬面接）を再設計した。本ドキュメントの一部（特に候補者向けの位置づけ・収益モデル・候補者レポートの制約）は再設計で更新されている。最新は `docs/superpowers/specs/2026-05-23-bulr-candidate-business-split-design.md` を参照。
